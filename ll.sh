...
#export LD_LIBRARY_PATH=/usr/local/bccl/lib:/workspace:/usr/local/nvshmem/lib:${LD_LIBRARY_PATH}
...
export NCCL_DEBUG_FILE=/ssd1/jinxihua/deepep/nccl_log/nccl.%h.%p.log
...
export MASTER_ADDR=10.55.119.229
